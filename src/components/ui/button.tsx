  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring",
  {
    variants: {
      variant: {
        ...
        destructive:
          "text-white bg-none shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/40",
        outline:
        ...
        icon:
          "bg-transparent text-muted-foreground shadow-xs hover:bg-neutral-900",
