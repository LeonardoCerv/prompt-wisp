import { ExternalLink, GraduationCap, Code, AppWindow, Contact } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                {/* Uncomment if you have a homepage
              ...
              <li>
                ...
                */}
                ...
                <li>
                 <Link href="/contact" className="text-moonlight-silver hover:text-moonlight-silver-bright transition-colors inline-flex items-center gap-1.5">
                  <Contact size={16} />
                  <span>Contact</span>
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/privacy-policy" className="text-moonlight-silver hover:text-moonlight-silver-bright transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms-of-service" className="text-moonlight-silver hover:text-moonlight-silver-bright transition-colors">
                  Terms of Service
                </Link>
              </li>
              { /* Uncomment if you have a cookie policy
              <li>
